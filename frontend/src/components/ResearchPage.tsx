    ...
    const dummys: ResearchDataProp[] = [
        {
            ...
            'imgPath': '../../public/research_images/liquid.png',
        ...
        },
        {
            ...
            'imgPath': '../../public/research_images/machinelearning.png',
        ...
        },
        {
            ...
            'imgPath': '../../public/research_images/portable.png',
        ...
        },
        {
            ...
            'imgPath': '../../public/research_images/materialprocessing.png',
    ...
    return (
        <>
            <nav id="navbar-example2 " className="navbar bg-light px-3 mb-3">
                <p className="navbar-brand"><strong>RESEARCH</strong></p>
            ...
            <div data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" className="scrollspy-example bg-light p-3 rounded-2">
                {dummys.map((dummy) => (
                    <div className="card mb-3" id={"scrollspyHeading_"+dummy.id} style={{maxWidth: '1000px'}} key={dummy.id}>
                        <div className="row">
